...
public class ConfigActivity_4X4 extends Activity {
	...
	private static final String TAG = "ConfigActivity_4X4";
	
	private View.OnClickListener listener = new View.OnClickListener() {
		
		@Override
		public void onClick(View v) {
			AlertDialog.Builder builder = new AlertDialog.Builder(ConfigActivity_4X4.this);
	...
	public void onBackPressed() {
		...
		editor.commit();
		AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(ConfigActivity_4X4.this);
